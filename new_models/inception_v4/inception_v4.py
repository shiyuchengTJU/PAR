...
def inceptionv4(num_classes=200, pretrained='imagenet'):
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(settings['url'], model_dir='/home/xyj/syc/adversarial_machine_leaninrg/nips_2018_competition/defence_gan/inception_v4/'))
