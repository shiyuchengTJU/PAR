...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, num_classes=1001, stem_filters=96, penultimate_filters=4032, filters_multiplier=2):
        ...
        self.upsample = nn.Upsample(scale_factor=6)
        ...
        self.last_linear = nn.Linear(16128, 200)
...
def nasnetalarge(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(settings['url'], model_dir='/home/xyj/syc/adversarial_machine_leaninrg/nips_2018_competition/defence_gan/nasnet/'))
